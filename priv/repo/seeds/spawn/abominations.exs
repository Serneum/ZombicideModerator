defmodule Abominations do
  defmodule Spawn do
    ...
    def seed() do
      Repo.insert!(%Set{id: 7, name: "Ablobination", has_spawn: true})
      Repo.insert!(%Set{id: 8, name: "Abominatroll", has_spawn: true})
      Repo.insert!(%Set{id: 9, name: "Abominotaur", has_spawn: true})
      Repo.insert!(%Set{id: 10, name: "Abominalpha", has_spawn: true})
      Repo.insert!(%Set{id: 11, name: "Abominarat", has_spawn: true})
